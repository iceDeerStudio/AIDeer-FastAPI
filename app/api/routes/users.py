...
@router.post("/me/password", response_model=ServerMessage)
...
@router.get("/me/avatar", response_class=RedirectResponse)
async def get_avatar(user: UserDep):
    return RedirectResponse(f"{config.api_base_url}{user.avatar}")


@router.post("/me/avatar", response_model=ServerMessage)
...
@router.delete("/{user_id}", response_model=ServerMessage)
...
@router.post("/{user_id}/password", response_model=ServerMessage)
...
@router.get("/{user_id}/avatar", response_class=RedirectResponse)
